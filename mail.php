...
$smtpUsername = "apikey";
$smtpPassword = "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";
...
if ($phone) {
    ...
    try {
        ...
        $mail->Port = 587;
        $mail->From = "no-replay@em6907.pracodidacol.com.co";
        $mail->CharSet = 'UTF-8';
        $mail->FromName = "Camapaña Subaru";

        $mail->AddAddress("devsolucionsoft@gmail.com");
        /* $mail->AddAddress("habeasdata@didacol.com"); */
        $mail->IsHTML(true);
        $mail->Subject = "Campaña Subaru"; // Este es el titulo del email.
        $body = "";
        $body .= "Nombres: " . $names . "<br/>";
        $body .= "Email: " . $email . "<br/>";
        $body .= "Celular: " . $phone . "<br/>";
        $body .= "Medio de Contacto: " . $subject . "<br/>";
        $body .= "Modelo: " . $model . "<br/>";
        $body .= "Tiempo Espera: " . $time . "<br/>";
        $body .= "Presupuesto: " . $budget . "<br/>";
        $body .= "Mensaje Adicional: " . $message . "<br/>";
...
<body>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="font-family:Open Sans,Verdana,Arial;font-size:20px;color:#87754e;font-weight:bold;line-height:38px" valign="middle" align="center">
                                                                    <u></u>Apreciado(a) Cliente ' . $names . ' ' . $last_name . ':<u></u>
                                                                </td>
                                                            </tr>
                                                            <tr>
    ...
    <!--/ Footer Mailling Mack -->
        ...
        $mail2->Port = 587;
        $mail2->From = "no-replay@em6907.pracodidacol.com.co";
        $mail2->FromName = "Campaña Subaru";
        $mail2->AddAddress($email);
        /* $mail2->AddAddress("habeasdata@didacol.com"); */
        $mail2->IsHTML(true);
        $mail2->Subject = "Autorización uso de datos - Pracodidacol.";
        $mail2->Body = $htmlautoresponse;
        $mail2->Send();

        $mail->Body = $body;
        $exito = $mail->Send();

        /* sendHabeasData($names, $last_name, $email, $phone); */
...
function sendHabeasData($name, $lastname, $email, $phone)
{
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://api.inchcapedigital.com/v1/habeasdata/digital/customers',
...
function getToken()
{
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://api.inchcapedigital.com/v1/oauth/token',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
        ...
        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
        CURLOPT_CUSTOMREQUEST => 'POST',
        CURLOPT_POSTFIELDS => 'client_id=GjxZgfacizpzjwqGoWwBGFc9ywRsA37hwakwgyIZFCNKjthv&client_secret=lbyRhByAiDSAZ2DCyAPuwiXaFgMDWtGAB9gCBH78TXzjAsEXvkyGqlF5FiCU4CSN&grant_type=client_credentials',
        CURLOPT_HTTPHEADER => array(
